...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhla2luc21lbiIsImEiOiJjbHBtdWo2emMwZG1xMnFxbm1ya2JoczkyIn0.hrXUZHWm5dt1BiDznzal2Q';
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable no-alert */ /* eslint-disable no-restricted-globals */ /* eslint-disable no-undef */
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', 'You have been logged out');
          return _context2.abrupt("return", window.setTimeout(function () {
            location.assign('/');
          }, 1000));
        case 7:
          _context2.next = 12;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"account.js":[function(require,module,exports) {
"use strict";
...
var profile = exports.profile = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Profile Updated Succesfully');
          }
          _context.next = 10;
          break;
        case 7:
  ...
  return function profile(_x) {
    return _ref.apply(this, arguments);
  };
}();
var password = exports.password = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currentPassword, _password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Password Updated Succesfully');
          }
          _context2.next = 10;
          break;
        case 7:
  ...
  return function password(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51OKeCHHzmpmNHc0vbKsnNqd3csDTNpWXFa11q2dlfHNoYEBzapKpB0YJVOWOSLKoIo18944jpqVbJ6c1D8GUnFlL00t6elzvlZ');
...
var auth = _interopRequireWildcard(require("./login"));
var user = _interopRequireWildcard(require("./account"));
var _alert = require("./alert");
...
var userSettings = document.querySelector('.form-user-data');
var userPassword = document.querySelector('.form-user-settings');
var bookButton = document.getElementById('book-tour');
if (bookButton) {
  bookButton.addEventListener('click', function (e) {
    e.preventDefault();
    bookButton.textContent = 'Processing...';
    var tourId = bookButton.dataset.tourId;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", (0, _alert.showAlert)('error', 'Please fill out required fields'));
          case 7:
            _context.next = 9;
            return user.password(currentPassword, newPassword, confirmPassword);
          case 9:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4902" + '/');
